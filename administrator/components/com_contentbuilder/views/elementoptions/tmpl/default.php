...
$pane = JPane::getInstance('tabs', array('startOffset'=>JRequest::getInt('tabStartOffset',0),'startTransition'=>0));
...
echo $pane->startPanel(JText::_( 'COM_CONTENTBUILDER_ELEMENT_OPTIONS' ), "tab0");
?>
        ...
        <table class="admintable" width="100%">
            ...
            ?>
               <tr>
                    ...
                    <td align="left">
                        <textarea style="width:100%;height:100px;" name="hint" id="hint"><?php echo isset($this->element->hint) ? htmlentities($this->element->hint, ENT_QUOTES, 'UTF-8') : '';?></textarea>
                    </td>
               </tr>
            <?php
            }
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="100%">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="max_filesize" id="max_filesize" value="<?php echo htmlentities(isset($this->element->options->max_filesize) && $this->element->options->max_filesize ? $this->element->options->max_filesize : '2M', ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="upload_directory" id="upload_directory" value="<?php echo htmlentities(isset($this->element->options->upload_directory) && $this->element->options->upload_directory ? $this->element->options->upload_directory : '', ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
        </table>
    </fieldset>    
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="100%">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="length" id="length" value="<?php echo isset($this->element->options->length) ?  $this->element->options->length : '';?>"/>
                    </td>
               </tr>
               <?php
               }
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width: 100%" type="text" name="horizontal_length" id="horizontal_length" value="<?php echo isset($this->element->options->horizontal_length) ? $this->element->options->horizontal_length : '';?>"/>
                    </td>
               </tr>
               <?php
               }
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="seperator" id="seperator" value="<?php echo isset($this->element->options->seperator) ? htmlentities($this->element->options->seperator, ENT_QUOTES, 'UTF-8') : ',';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="100%">
               <tr>
                    ...
                    <td align="left">
                        <textarea style="width: 100%; height: 100px;" name="default_value" id="default_value" ><?php echo isset($this->element->default_value) ? htmlentities($this->element->default_value, ENT_QUOTES, 'UTF-8') : '';?></textarea>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="width" id="width" value="<?php echo isset($this->element->options->width) ? $this->element->options->width : '100%';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="height" id="height" value="<?php echo isset($this->element->options->height) ? $this->element->options->height : '200px';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="maxlength" id="maxlength" value="<?php echo isset($this->element->options->maxlength) ? $this->element->options->maxlength : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="100%">
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="default_value" id="default_value" value="<?php echo isset($this->element->default_value) ? htmlentities($this->element->default_value, ENT_QUOTES, 'UTF-8') : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="length" id="length" value="<?php echo isset($this->element->options->length) ?  $this->element->options->length : '100%';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="format" id="format" value="<?php echo isset($this->element->options->format) ? $this->element->options->format : '%Y-%m-%d';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="transfer_format" id="transfer_format" value="<?php echo isset($this->element->options->transfer_format) ? $this->element->options->transfer_format : 'YYYY-mm-dd';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
...
echo $pane->startPanel( JText::_( 'COM_CONTENTBUILDER_ELEMENT_OPTIONS_SCRIPTS' ), "tab1" );
?>
    <h3><?php echo htmlentities($this->element->label, ENT_QUOTES, 'UTF-8');?></h3>
    <?php
    ...
    ?>
    <fieldset class="adminform">
        <legend><?php echo JText::_( 'COM_CONTENTBUILDER_ELEMENT_VALIDATION' ); ?></legend>
        <table class="admintable" width="100%">
                <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input style="width:100%;" type="text" name="validation_message" id="validation_message" value="<?php echo htmlentities($this->element->validation_message, ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <select style="width: 100%;height: 100px;" multiple="multiple" name="validations[]" id="validations">
                         <?php
               ...
               <tr>
                    ...
                    <td align="left">
                        <textarea style="width:100%;height:200px;" name="custom_validation_script" id="custom_validation_script"><?php echo htmlentities($this->element->custom_validation_script, ENT_QUOTES, 'UTF-8');?></textarea>
                    </td>
               </tr>
        </table>
    </fieldset>
    ...
    ?>
    <fieldset class="adminform">
        <legend><?php echo JText::_( 'COM_CONTENTBUILDER_ELEMENT_INIT' ); ?></legend>
        <table class="admintable" width="100%">
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <textarea style="width:100%;height:200px;" name="custom_init_script" id="custom_init_script"><?php echo htmlentities($this->element->custom_init_script, ENT_QUOTES, 'UTF-8');?></textarea>
                    </td>
               </tr>
        </table>
    </fieldset>
